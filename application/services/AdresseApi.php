...
class Service_AdresseApi
{
    ...
    public function getAdresseApi(string $query, string $type, int $limit): ?array
    {
        ...
        $client->setParameterGet('limit', (string) $limit);
        $client->setConfig([
        ...
        } catch (Zend_Http_Client_Exception $zendHttpClientException) {
            error_log("Erreur lors de l'accès à l'API : ".$zendHttpClientException->getMessage());
